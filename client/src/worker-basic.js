...
var Driver = (function () {
    function Driver(manifestUrl, plugins, scope, adapter, cache, events, fetcher) {
        ...
        events.message = function (event) {
            ...
            _this.init.then(function () {
                ...
                _this.lifecycle("msg[" + id + "]: " + JSON.stringify(event.data));
    ...
    Driver.prototype.reset = function () {
        ...
        return this
            .scopedCache
            .keys()
            .then(function (keys) { return Promise.all(keys.map(function (key) { return _this.scopedCache.remove(key); }))
     ...
     */
    Driver.prototype.doUpdate = function () {
        var _this = this;
        return this
            .fetchManifestFromCache('staged')
            .then(function (manifest) {
            if (!manifest) {
                _this.goToState(DriverState.READY);
                return null;
            }
            return _this
    ...
    Driver.prototype.checkForUpdate = function () {
        ...
        return Promise
            ...
            if (!!staged && staged._hash === network._hash) {
                ...
                _this.goToState(DriverState.UPDATE_PENDING);
                return true;
            }
    ...
    Driver.prototype.initialize = function () {
        ...
        return Promise.all([
            ...
            if (!active) {
                _this.goToState(DriverState.INSTALLING);
            ...
            return _this
                ...
                .then(function (worker) {
                if (!worker) {
                    _this.goToState(DriverState.LAME);
                    return;
                }
    ...
    Driver.prototype.cleanup = function (worker) {
        ...
        worker
            ...
            .then(function () { return _this.lifecycle("cleaned up old version " + worker.manifest._hash); });
    };
    ...
    Driver.prototype.goToState = function (state) {
        var _this = this;
